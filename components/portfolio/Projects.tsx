...
const caseStudies = [
  ...
  {
    number: "02",
    tag: "Projet personnel · Product Builder IA · Positionnement candidat",
    title: "ProductSignal — assistant IA d'analyse d'offres PM et de positionnement candidat",
    subtitle: "Cadrage MVP · Scoring · IA appliquée · Claude Code · Itération",
    description:
      "ProductSignal est un projet personnel Product Builder IA en cours d'itération. L'objectif : aider les candidats PM à lire les bons signaux dans une offre, comprendre les attentes implicites, mesurer leur niveau de compatibilité et améliorer leur positionnement avant de candidater.",
    problem:
      "Trouver les offres PM vraiment pertinentes et formuler un positionnement précis pour chaque candidature demande un effort cognitif élevé. Lire des dizaines d'offres, identifier les exigences implicites, évaluer les écarts profil / poste en temps réel : aucun outil existant ne permettait ce niveau d'analyse personnalisée et contextuelle.",
    approach:
      "Partir du problème vécu, le valider, définir le périmètre minimal utile. Cadrage MVP, définition des critères de scoring, structuration du parcours utilisateur et prototypage assisté par Claude Code pour relier besoin utilisateur, IA appliquée et delivery.",
    solution:
      "Outil IA conçu et prototypé : analyse d'offres PM, scoring de compatibilité personnalisé, identification des attentes implicites des recruteurs, détection des écarts profil / poste et recommandations de positionnement pour chaque candidature.",
    results: [
      "Besoin réel identifié, validé et cadré en MVP",
      "Critères de scoring définis, parcours utilisateur structuré",
      "Prototypage assisté par Claude Code : IA appliquée et delivery",
      "Boucle problem → MVP → itération démontrée en autonomie produit",
      "Positionnement PM affiné candidature par candidature",
    ],
    realProject: {
